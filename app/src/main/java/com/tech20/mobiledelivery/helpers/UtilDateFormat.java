...
public class UtilDateFormat {
    ...
    public static Date format(String fromPattern,String date) throws ParseException {
    ...
    public static String getToday(){
        ...
        return UtilDateFormat.format(UtilDateFormat.yyyy_MM_dd_T_HH_mm_ss,calendar.getTime());
    }
}
