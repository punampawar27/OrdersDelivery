...
public class InsertRunnable implements Runnable{
    ...
    private void saveData(DatabaseHouse dataHouse,PreferenceUtils preferenceUtils,LoginResponse loginResponse,ModelLogin.ICallBackLogin callback){
        ...
        LoginResponse.DriverDetails driverDetails = loginResponse.getDriverDetails();
        ...
        dbModelDriver.setDriverId(driverDetails.getDriverId());

        dbModelDriver.setStore_id(Integer.parseInt(storeDetails.getId()));
        dbModelDriver.setFirst_name(driverDetails.getFirstName());
        dbModelDriver.setLast_name(driverDetails.getLastName());
        dbModelDriver.setUsername(driverDetails.getUserName());
        dbModelDriver.setCity(driverDetails.getCity());
        dbModelDriver.setState(driverDetails.getState());
        dbModelDriver.setZipcode(driverDetails.getZipcode());
        dbModelDriver.setCountry(driverDetails.getCountry());
        dbModelDriver.setLicenceNo(driverDetails.getLicenceNo());
        dbModelDriver.setVehicleNumber(driverDetails.getVehicleNumber());

        dbModelDriver.setMobileNumber(driverDetails.getMobileNumber());
        dbModelDriver.setAddressLine1(driverDetails.getAddressLine1());
        dbModelDriver.setAddressLine2(driverDetails.getAddressLine2());
